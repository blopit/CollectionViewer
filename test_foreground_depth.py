#!/usr/bin/env python3
"""
Test script for foreground-focused depth map generation.

This script demonstrates how to use the foreground_depth.py script
with different foreground segmentation methods.

Usage:
    python test_foreground_depth.py --input <input_video>
"""
...
def main():
    ...
    methods = ["grabcut", "bgsubtract", "watershed"]
